    ...
    public function merger($query_obj, $is_single_row = false)
    {
        if (!$is_single_row) {
            ...
            foreach ($favourites as $key => $favourite) {
                ...
                $foodtruck_details = $this->foodtruck_model->get_by_id($menu_details['foodtruck_id']);
                ...
                $favourites[$key]['foodtruck_name']  = $foodtruck_details['name'];
                $favourites[$key]['foodtruck_slug']  = $foodtruck_details['slug'];
                $favourites[$key]['foodtruck_id']  = $foodtruck_details['id'];
            }
            return $favourites;
        } else {
            ...
            $favourite['foodtruck_name']  = $foodtruck_details['name'];
            $favourite['foodtruck_slug']  = $foodtruck_details['slug'];
            $favourite['foodtruck_id']  = $foodtruck_details['id'];
            return $favourite;
        }
    }
