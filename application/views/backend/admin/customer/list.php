  ...
  <div class="row justify-content-center">
    <div class="col-md-12">
      <div class="alert alert-info alert-dismissible fade show lighten-info" role="alert">
        ...
        <p>
          <?php echo get_phrase('every_foodtruck_owner_is_also_a_customer'); ?>. <?php echo get_phrase('a_foodtruck_owner_has_all_the_features_that_a_customer_has'); ?>.
        </p>
            ...
            <div class="row">
              <div class="col-7">
                <?php if (is_foodtruck_owner(sanitize($customer['id']))) : ?>
                  <div class="text-muted text-sm mb-1"><i class="fas fa-user-tie"></i> <strong><span class="badge badge-info lighten-info"><?php echo get_phrase('foodtruck_owner'); ?></span></strong> </div>
                <?php endif; ?>
