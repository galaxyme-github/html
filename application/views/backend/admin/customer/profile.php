    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-3">
                    ...
                    <div class="card-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            <li class="list-group-item">
                                ...
                                <a class="float-right">
                                    <?php if (sanitize($customer['status'])) : ?>
                        ...
                        <?php if ($customer['status']) : ?>
                            <a href="javascript:void(0)" onclick="confirm_modal('<?php echo site_url('customer/update_status/' . sanitize($customer['id'])); ?>')" class="btn btn-danger btn-block"><b><?php echo get_phrase('mark_as_pending'); ?></b></a>
                        <?php else : ?>
                            <a href="javascript:void(0)" onclick="confirm_modal('<?php echo site_url('customer/update_status/' . sanitize($customer['id'])); ?>')" class="btn btn-success btn-block"><b><?php echo get_phrase('mark_as_approved'); ?></b></a>
                        <?php endif; ?>
                    </div>
                    <!-- /.card-body -->
                </div>
                ...
                <?php if (is_foodtruck_owner(sanitize($customer['id']))) : ?>
                    <!-- Food Truck owner Box -->
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title"><?php echo get_phrase('foodtruck_owner_of', true); ?></h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <?php $foodtrucks = $this->foodtruck_model->get_foodtrucks_by_condition(['owner_id' => sanitize($customer['id'])]); ?>
                            <?php if (count($foodtrucks) > 0) : ?>
                                <?php foreach ($foodtrucks as $key => $foodtruck) : ?>
                                    <strong><i class="fas fa-utensils"></i></strong> <a href="<?php echo site_url('home/foodtruck/' . sanitize(rawurlencode($foodtruck['slug'])) . '/' . sanitize($foodtruck['id'])); ?>"><span class="text-muted"><?php echo sanitize($foodtruck['name']); ?></span></a>
                                    <?php if ($foodtruck['status']) : ?>
                                        <span class="badge badge-success lighten-success"><?php echo get_phrase('approved'); ?></span>
                                    <?php else : ?>
                                        <span class="badge badge-danger lighten-danger"><?php echo get_phrase('pending'); ?></span>
                                    <?php endif; ?>
                                ...
                                <?php endforeach; ?>
                            <?php else : ?>
                                <div class="alert alert-warning lighten-warning"><?php echo get_phrase('this_foodtruck_owner_does_not_have_any_foodtruck_created'); ?>. <?php echo get_phrase('you_can_mark_his_as_customer_only'); ?></div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="<?php if ($tab == "profile") echo "active"; ?> tab-pane" id="profile">
                                <form action="<?php echo site_url('customer/update'); ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="email" name="email" class="form-control" id="email" placeholder="<?php echo get_phrase('provide_valid_email'); ?>" value="<?php echo sanitize($customer['email']); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="phone" class="col-sm-2 col-form-label"><?php echo get_phrase("phone"); ?><span class="text-danger">*</span></label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="phone" name="phone" placeholder="<?php echo get_phrase("enter_phone"); ?>" value="<?php echo sanitize($customer['phone']); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                            ...
                            <div class="tab-pane" id="address_1">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="address_1" class="form-control" id="address_1" rows="5" placeholder="<?php echo get_phrase('provide_full_address'); ?>."><?php echo sanitize($customer['address_1']); ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="latitude_1" class="col-sm-2 col-form-label"><?php echo get_phrase('latitude'); ?><span class='text-danger'>*</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="latitude_1" class="form-control" id="latitude_1" placeholder="<?php echo get_phrase('latitude_for_address_1'); ?>" value="<?php echo sanitize($customer['coordinate_1']['latitude']); ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="longitude_1" name="longitude_1" placeholder="<?php echo get_phrase("longitude_for_address_1"); ?>" value="<?php echo sanitize($customer['coordinate_1']['longitude']); ?>">
                                        <small class="float-right"><a href="https://youtu.be/CgFiSJ11Uk8" target="_blank"><?php echo get_phrase("how_to_get_it"); ?>?</a></small>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="address_2">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="address_2" class="form-control" id="address_2" rows="5" placeholder="<?php echo get_phrase('provide_full_address'); ?>."><?php echo sanitize($customer['address_2']); ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="latitude_2" class="col-sm-2 col-form-label"><?php echo get_phrase('latitude'); ?></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="latitude_2" class="form-control" id="latitude_2" placeholder="<?php echo get_phrase('latitude_for_address_2'); ?>" value="<?php echo sanitize($customer['coordinate_2']['latitude']); ?>">
                                        <small class="float-right"><a href="https://youtu.be/CgFiSJ11Uk8" target="_blank"><?php echo get_phrase("how_to_get_it"); ?>?</a></small>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="longitude_2" name="longitude_2" placeholder="<?php echo get_phrase("longitude_for_address_2"); ?>" value="<?php echo sanitize($customer['coordinate_2']['longitude']); ?>">
                                        <small class="float-right"><a href="https://youtu.be/CgFiSJ11Uk8" target="_blank"><?php echo get_phrase("how_to_get_it"); ?>?</a></small>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="address_3">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="address_3" class="form-control" id="address_3" rows="5" placeholder="<?php echo get_phrase('provide_full_address'); ?>."><?php echo sanitize($customer['address_3']); ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="latitude_3" class="col-sm-2 col-form-label"><?php echo get_phrase('latitude'); ?></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="latitude_3" class="form-control" id="latitude_3" placeholder="<?php echo get_phrase('latitude_for_address_3'); ?>" value="<?php echo sanitize($customer['coordinate_3']['latitude']); ?>">
                                        <small class="float-right"><a href="https://youtu.be/CgFiSJ11Uk8" target="_blank"><?php echo get_phrase("how_to_get_it"); ?>?</a></small>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="longitude_3" name="longitude_3" placeholder="<?php echo get_phrase("longitude_for_address_3"); ?>" value="<?php echo sanitize($customer['coordinate_3']['longitude']); ?>">
                                        <small class="float-right"><a href="https://youtu.be/CgFiSJ11Uk8" target="_blank"><?php echo get_phrase("how_to_get_it"); ?>?</a></small>
                                    </div>
                                </div>
                            </div>
