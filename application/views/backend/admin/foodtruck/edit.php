						...
						<form action="<?php echo site_url('foodtruck/update/basic'); ?>" method="post">
							...
							<div class="row">
								<div class="col-lg-6">
									...
									<div class="form-group">
                                        <label for="needs_on_location"><?php echo get_phrase("needs_on_location"); ?></label>
                                        <input type="text" id="needs_on_location" data-role="tagsinput" class="form-control" data-removeBtn="true" name="needs_on_location" value="<?php echo sanitize($foodtruck_data['needs_on_location']); ?>" placeholder="<?php echo get_phrase("insert_needs_on_serve_location_and_press_enter"); ?> ( electricty, water)">
                                    </div>
									<div class="form-group">
						...
						<form action="<?php echo site_url('foodtruck/update/address'); ?>" method="post">
							...
							<div class="row">
								<div class="col-lg-6">
									...
									<div class="form-group">
                                        <label for="serviceable_areas"><?php echo get_phrase("areas_we_serve"); ?></label>
                                        <input type="text" id="serviceable_areas" data-role="tagsinput" class="form-control" data-removeBtn="true" name="serviceable_areas" value="<?php echo sanitize($foodtruck_data['serviceable_areas']); ?>" placeholder="<?php echo get_phrase("insert_serve_areas_and_press_enter"); ?> ( North Holland, South Holland)">
                                    </div>
									<div class="form-group">
								...
								<div class="col-lg-6">
									...
									<div id="new_user_area" class="hidden">
										<div class="form-group">
											...
											<input type="text" id="foodtruck_owner_name" class="form-control" name="foodtruck_owner_name" placeholder="<?php echo get_phrase("enter_foodtruck_owner_name"); ?>" value="">
										</div>
										<div class="form-group">
											<label for="foodtruck_owner_email"><?php echo get_phrase("foodtruck_owner_email"); ?></label>
											<input type="email" class="form-control" id="foodtruck_owner_email" name="foodtruck_owner_email" placeholder="<?php echo get_phrase("enter_foodtruck_owner_email"); ?>" value="">
										</div>
										<div class="form-group">
											<label for="foodtruck_owner_password"><?php echo get_phrase("foodtruck_owner_password"); ?></label>
											<input type="password" class="form-control" id="foodtruck_owner_password" name="foodtruck_owner_password" placeholder="<?php echo get_phrase("enter_foodtruck_owner_password"); ?>" value="">
										</div>
									</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
										...
										<input type="number" id="delivery_charge" class="form-control" name="delivery_charge" placeholder="<?php echo get_delivery_settings('delivery_charge') . ' (' . get_phrase("default") . ') '; ?>" value="<?php echo sanitize($foodtruck_data['delivery_charge']); ?>" min="0">
									</div>
									<div class="form-group clockpicker">
										<label for="maximum_time_to_deliver"><?php echo get_phrase("maximum_time_to_deliver"); ?></label>
										<input type="text" class="form-control" id="maximum_time_to_deliver" name="maximum_time_to_deliver" placeholder="<?php echo get_delivery_settings('maximum_time_to_deliver') . ' (' . get_phrase("default") . ') '; ?>" value="<?php echo sanitize($foodtruck_data['maximum_time_to_deliver']); ?>">
									</div>
