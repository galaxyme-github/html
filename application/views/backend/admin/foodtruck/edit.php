...
<section class="content">
    <div class="container-fluid">
        <!-- Custom Tabs -->
        <div class="card">
            <div class="card-header ft-hero-tabs d-flex p-0">
                <ul class="nav nav-pills p-2">
                    ...
                    <li class="nav-item"><a href="<?php echo site_url('foodtruck/edit/' . sanitize($id) . '/owner'); ?>" class="nav-link <?php if ($active_tab == 'owner') echo 'active' ?>"><?php echo get_phrase('owner_data') ?></a></li>
            ...
            <div class="card-body">
                <div class="tab-content">
                        ...
                        <form action="<?php echo site_url('foodtruck/update/basic'); ?>" method="post">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <label for="attendees_amt"><?php echo get_phrase("amount_of_attendees"); ?></label>
                                        <div class="ft-hero-select">
                                            <select id="attendees_amt" name="attendees_amt" required>
                                                <option value=""><?php echo get_phrase("select_amount_of_attendees"); ?></option>
                                                <option value="40-60" <?php if ($foodtruck_data["attendees_amt"]=="40-60") echo "selected" ?>>40-60</option>
                                                <option value="60-100" <?php if ($foodtruck_data["attendees_amt"]=="60-100") echo "selected" ?>>60-100</option>
                                                <option value="100-200" <?php if ($foodtruck_data["attendees_amt"]=="100-200") echo "selected" ?>>100-200</option>
                                                <option value="200-300" <?php if ($foodtruck_data["attendees_amt"]=="200-300") echo "selected" ?>>200-300</option>
                                                <option value="300+" <?php if ($foodtruck_data["attendees_amt"]=="300+") echo "selected" ?>>300+</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="minimum_price_pp"><?php echo get_phrase("minimum_price_per_person"); ?></label>
                                        <input type="number" class="form-control" id="minimum_price_pp" name="minimum_price_pp" value="<?php echo sanitize($foodtruck_data['minimum_price_pp']); ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="needs_on_location">What things is needed on event location(electricty, water)?</label>
                                        <input type="text" id="needs_on_location" data-role="tagsinput" class="form-control" data-removeBtn="true" name="needs_on_location" value="<?php echo sanitize($foodtruck_data['needs_on_location']); ?>">
                                    </div>
                                    <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="7" id="foodtruck_description" name="foodtruck_description" required><?php echo sanitize($foodtruck_data['description']); ?></textarea>
                                    </div>
                                    <!-- <div class="form-group">
                                        ...
                                        <div class="radio-list">
                                            <div class="radio-inline pl-0">
                                                <span class="radio radio-info">
                                                    <input type="radio" name="service_type" id="radio_1" value="0" <?php if ($foodtruck_data['service_type'] == 0): ?>checked<?php endif; ?>>
                                                    <label for="radio_1">Catering and A la Cart</label>
                                                </span>
                                            </div>
                                            <div class="radio-inline ml-3">
                                                <span class="radio radio-info">
                                                    <input type="radio" name="service_type" id="radio_2" value="1" <?php if ($foodtruck_data['service_type'] == 1): ?>checked<?php endif; ?>>
                                                    <label for="radio_2">Only Catering </label>
                                                </span>
                                            </div>
                                            <div class="radio-inline ml-3">
                                                <span class="radio radio-info">
                                                    <input type="radio" name="service_type" id="radio_3" value="2" <?php if ($foodtruck_data['service_type'] == 2): ?>checked<?php endif; ?>>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="foodtruck_address" name="foodtruck_address" required><?php echo sanitize($foodtruck_data['address']); ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="foodtruck_zipcode"><?php echo get_phrase("zipcode"); ?></label>
                                        <input type="text" class="form-control" id="foodtruck_zipcode" name="foodtruck_zipcode" value="<?php echo sanitize($foodtruck_data['zip_code']); ?>" required>
                                    </div>
                                    <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="foodtruck_serve_radius" class="form-control" name="foodtruck_serve_radius" value="<?php echo sanitize($foodtruck_data['serve_radius']); ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="serviceable_areas">Areas foodtruck serve? ex: (North Holland, South Holland)</label>
                                        <input type="text" id="serviceable_areas" data-role="tagsinput" class="form-control" data-removeBtn="true" name="serviceable_areas" value="<?php echo sanitize($foodtruck_data['serviceable_areas']); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="foodtruck_phone"><?php echo get_phrase("phone"); ?></label>
                                        <input type="text" class="form-control" id="foodtruck_phone" name="foodtruck_phone" value="<?php echo sanitize($foodtruck_data['phone']); ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="foodtruck_website_link"><?php echo get_phrase("foodtruck_website_link"); ?></label>
                                        <input type="text" class="form-control" id="foodtruck_website_link" name="foodtruck_website_link" value="<?php echo sanitize($foodtruck_data['website']); ?>" required>
                                    </div>
                    ...
                    <div class="tab-pane <?php if ($active_tab == 'owner') echo 'active' ?>" id="owner">
                        <form action="<?php echo site_url('foodtruck/update/owner'); ?>" method="post">
                            <input type="hidden" name="id" value="<?php echo sanitize($foodtruck_data['id']); ?>">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" id="existing_user" name="foodtruck_owner_type" checked value="existing" onclick="toggleUserArea(this)">
                                        <label for="existing_user" class="custom-control-label"><?php echo get_phrase("choose_from_existing_foodtruck_owners_and_customers"); ?></label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" id="new_user" name="foodtruck_owner_type" value="new" onclick="toggleUserArea(this)">
                                        <label for="new_user" class="custom-control-label"><?php echo get_phrase("create_a_new_foodtruck_owner"); ?></label>
                                    </div>
                                    <br>
                                    <div id="existing_user_area">
                                        <div class="form-group">
                                            <label id="foodtruck_owner_id"><?php echo get_phrase("choose_from_existing_foodtruck_owners_and_customers"); ?></label>
                                            <select class="form-control select2 w-100" id="foodtruck_owner_id" name="foodtruck_owner_id">
                                                ...
                                                foreach ($approved_users as $key => $approved_user) : ?>
                                                    <option value="<?php echo sanitize($approved_user['id']); ?>" <?php if ($approved_user['id'] == $foodtruck_data['owner_id']) echo "selected"; ?>><?php echo sanitize($approved_user['name']); ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div id="new_user_area" class="hidden">
                                        <div class="form-group">
                                            <label for="foodtruck_owner_name"><?php echo get_phrase("foodtruck_owner_name"); ?></label>
                                            <input type="text" id="foodtruck_owner_name" class="form-control" name="foodtruck_owner_name" value="">
                                        </div>
                                        <div class="form-group">
                                            <label for="foodtruck_owner_email"><?php echo get_phrase("foodtruck_owner_email"); ?></label>
                                            <input type="email" class="form-control" id="foodtruck_owner_email" name="foodtruck_owner_email" value="">
                                        </div>
                                        <div class="form-group">
                                            <label for="foodtruck_owner_password"><?php echo get_phrase("foodtruck_owner_password"); ?></label>
                                            <input type="password" class="form-control" id="foodtruck_owner_password" name="foodtruck_owner_password" value="">
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="delivery_charge" class="form-control" name="delivery_charge"  value="<?php echo sanitize($foodtruck_data['delivery_charge']); ?>" min="0">
                                    </div>
                                    <div class="form-group clockpicker">
                                        <label for="maximum_time_to_deliver"><?php echo get_phrase("maximum_time_to_deliver"); ?></label>
                                        <input type="text" class="form-control" id="maximum_time_to_deliver" name="maximum_time_to_deliver" value="<?php echo sanitize($foodtruck_data['maximum_time_to_deliver']); ?>">
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="avatar-upload">
                                    ...
                                    <div class="avatar-preview">
                                        <div id="foodtruck_thumbnail_preview" thumbnail="<?php echo base_url('uploads/foodtruck/thumbnail/' . $foodtruck_data['thumbnail']); ?>"></div>
                                    </div>
                                </div>
                            </div>
