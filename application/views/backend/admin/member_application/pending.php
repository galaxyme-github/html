        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        Booking Food Truck Member Applications on Pending
                    </h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                            ...
                            foreach ($applications as $application) : ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?php echo site_url('bft-member/application-details/pending/' . sanitize($application['code'])); ?>" class="btn btn-rounded btn-outline-primary btn-sm mt-2">Details</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
