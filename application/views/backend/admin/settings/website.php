            ...
            <div class="col-lg-12">
                <div class="card card-secondary">
                    <div class="card-header">
                        <h3 class="card-title">Website Basic Information</h3>
                    </div>
                    <div class="card-body">
                        <form action="<?php echo site_url('settings/update'); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="twitter_link"><?php echo get_phrase("pinterest_link"); ?></label>
                                <input type="text" id="pinterest_link" class="form-control" name="pinterest_link" placeholder="<?php echo get_phrase("enter_pinterest_link"); ?>" value="<?php echo sanitize($social_links['pinterest']); ?>">
                            </div>
                            <!-- <div class="form-group">
                            ...
                            <button class="btn ft-hero-btn">Update website settings</button>
                        </form>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                <form action="<?php echo site_url('settings/update'); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <button class="btn ft-hero-btn btn-sm">Update backend logo</button>
                                </form>
                            </div>
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                <form action="<?php echo site_url('settings/update'); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <button class="btn ft-hero-btn btn-sm">Update website logo</button>
                                </form>
                            </div>
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                <form action="<?php echo site_url('settings/update'); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <button class="btn ft-hero-btn btn-sm">Update favicon</button>
                                </form>
                            </div>
                        </div>
                    </div>
