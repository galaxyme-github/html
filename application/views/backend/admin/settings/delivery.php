        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="alert alert-info lighten-info" role="alert">
                    ...
                    <p>
                        <?php echo get_phrase('this_is_the_global_delivery_cahrge'); ?> <?php echo get_phrase('for'); ?> <strong><?php echo get_phrase('each'); ?></strong> <?php echo get_phrase('foodtruck'); ?>. <br>
                        <?php echo get_phrase('you_can_overwrite_the_charge_for_individual_foodtruck_from_their_edit_section'); ?>.
                    </p>
                </div>
