                        ...
                        <form action="<?php echo site_url('settings/update'); ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="number" id="admin_revenue" class="form-control" name="admin_revenue" placeholder="<?php echo get_phrase("admin_revenue_percentage"); ?>" value="<?php echo sanitize(get_delivery_settings('admin_revenue')); ?>" min=0; onkeyup="calculateFoodtruckRevenue(this.value)" required>
                            ...
                            <div class="form-group">
                                <label for="foodtruck_revenue"><?php echo get_phrase("foodtruck_revenue_percentage"); ?></label>
                                <div class="input-group mb-3">
                                    <input type="number" id="foodtruck_revenue" class="form-control bg-white" name="foodtruck_revenue" placeholder="<?php echo get_phrase("foodtruck_revenue_percentage"); ?>" value="<?php echo sanitize(get_delivery_settings('foodtruck_revenue')); ?>" min=0; readonly required>
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="fas fa-percentage"></i></span>
                                    </div>
                                </div>
