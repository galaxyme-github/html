        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <?php echo get_phrase("list_of_applications_waiting_for_review", true); ?>
                    </h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                            ...
                            foreach ($applications as $application) : ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?php echo site_url('applications/details/pending/' . sanitize($application['code'])); ?>" class="btn btn-rounded btn-outline-primary btn-sm mt-2"><?php echo get_phrase('details'); ?></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
