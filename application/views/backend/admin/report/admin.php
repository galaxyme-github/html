                        ...
                        <tbody>
                            <?php foreach ($commissions as $key => $commission) :
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo site_url('home/foodtruck/' . rawurlencode(sanitize($foodtruck_detail['slug'])) . '/' . sanitize($foodtruck_detail['id'])); ?>" target="_blank"><?php echo sanitize($foodtruck_detail['name']); ?></a><br>
