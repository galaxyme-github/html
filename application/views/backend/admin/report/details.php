        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <?php echo get_phrase("order_wise_commission_list_for_owner", true); ?> <small>( <?php echo get_delivery_settings('foodtruck_revenue') . '% ' . get_phrase('commission_in_each_order') ?>)</small>
                    </h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
