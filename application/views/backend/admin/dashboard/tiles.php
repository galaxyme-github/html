...
<div class="row">
    ...
    <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box">
            <span class="info-box-icon bg-gradient-olive"><i class="fas fa-truck-moving"></i></span>
            <div class="info-box-content">
                ...
                <span class="info-box-number">
                    <?php echo sanitize(count($this->foodtruck_model->get_all_approved())); ?>
                </span>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box">
            <span class="info-box-icon bg-gray-dark"><i class="fas fa-truck-moving"></i></span>
            <div class="info-box-content">
                ...
                <span class="info-box-number">
                    <?php echo sanitize(count($this->foodtruck_model->get_all_pending())); ?>
                </span>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">
                    <?php echo sanitize(count($this->user_model->get_approved_owners())); ?>
                </span>
            </div>
        </div>
    </div>
