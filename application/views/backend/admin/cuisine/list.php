        ...
        <div class="col-lg-3">
            ...
            <div class="card">
                ...
                <div class="card-body box-profile">
                    ...
                    <p class=" text-center"><small class="text-muted"><?php echo count($this->foodtruck_model->get_foodtrucks_by_cuisine($cuisine['id'])) . ' ' . get_phrase('foodtrucks_registered'); ?></small></p>
