      ...
      <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
        <div class="card bg-light">
          ...
          <div class="card-body pt-0">
            <div class="row">
              <div class="col-7">
                <div class="text-muted text-sm mb-1"><i class="far fa-calendar-check"></i> <b><?php echo get_phrase('approved_foodtrucks'); ?></b>:
                  <?php if (sanitize($owner['number_of_approved_foodtrucks'])) : ?>
                    <?php echo sanitize($owner['number_of_approved_foodtrucks']); ?>
                  <?php else : ?>
                    <span class="badge badge-danger lighten-danger"><?php echo sanitize($owner['number_of_approved_foodtrucks']); ?></span>
                  <?php endif; ?>
                </div>
                <div class="text-muted text-sm mb-1"><i class="far fa-calendar-times"></i> <b><?php echo get_phrase('pending_foodtrucks'); ?></b>:
                  <?php if (sanitize($owner['number_of_pending_foodtrucks'])) : ?>
                    <?php echo sanitize($owner['number_of_pending_foodtrucks']); ?>
                  <?php else : ?>
                    <span class="badge badge-danger lighten-danger"><?php echo sanitize($owner['number_of_pending_foodtrucks']); ?></span>
                  <?php endif; ?>
                </div>
