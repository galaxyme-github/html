            ...
            <div class="row justify-content-sm-center">
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <select class="form-control select2 w-100" name="foodtruck_id">
                ...
                <div class="card card-info card-outline">
                    <div class="card-body box-profile">
                        ...
                        <div class="text-center mb-2">
                            <small><?php echo get_phrase('foodtruck'); ?> : <strong><?php echo sanitize($menu['foodtruck_name']); ?></strong></small>
                        </div>
