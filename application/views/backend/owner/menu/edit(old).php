        ...
        <div class="card">
            <div class="card-header d-flex p-0">
                <ul class="nav nav-pills p-2">
                    ...
                    <li class="nav-item"><a href="javascript:void(0);" class="nav-link text-white btn btn-danger ml-2" onclick="confirm_modal('<?php echo site_url('menu/delete/' . $id); ?>')"><?php echo get_phrase('delete_this_menu') ?></a></li>
                </ul>
            </div><!-- /.card-header -->
            <div class="card-body">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div id="per_plate_price_area" class="<?php if ($menu_data['servings'] == "menu") echo "hidden"; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="full_plate_price" name="full_plate_price" onkeyup="calculateDiscountPercentage('full_plate')" placeholder="<?php echo get_phrase('enter_full_plate_price'); ?>" min="0" value="<?php echo sanitize($menu_data['servings']) == "plate" ? $actual_price_decodable['full_plate'] : 0;  ?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="full_plate_discounted_price" id="full_plate_discounted_price" onkeyup="calculateDiscountPercentage('full_plate')" min="0" value="<?php echo sanitize($menu_data['servings']) == "plate" ? $discounted_price_decodable['full_plate'] : 0;  ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="half_plate_discounted_price" id="half_plate_discounted_price" onkeyup="calculateDiscountPercentage('half_plate')" min="0" value="<?php echo sanitize($menu_data['servings']) == "plate" ? $discounted_price_decodable['half_plate'] : 0;  ?>">
                                            <small class="text-muted"><?php echo get_phrase('it_has'); ?>
