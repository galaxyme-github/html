                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div id="per_menu_price_area">
                                        <div class="form-group">
                                            <label for="per_menu_price"><?php echo 'Dish Price (' . currency_code_and_symbol('code') . ')'; ?> <span class="text-success">*</span></label>
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="per_menu_discount_flag"><?php echo get_phrase('check_if_this_dish_has_discount'); ?></label>
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            <label for="per_menu_discounted_price"><?php echo get_phrase("discounted_price") . ' (' . currency_code_and_symbol('code') . ')'; ?></label>
                                            <input type="number" class="form-control" name="per_menu_discounted_price" id="per_menu_discounted_price" onkeyup="calculateDiscountPercentage('per_menu', this.value)" min="0">
                                            <small class="text-muted"><?php echo get_phrase('this_menu_has'); ?> <span id="per_menu_discounted_percentage" class="text-success">0%</span> <?php echo get_phrase('discount'); ?></small>
                                        </div>
                                    </div>
                                    <div class="custom-control custom-checkbox">
