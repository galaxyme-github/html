                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="tags" class="tagged form-control" data-removeBtn="true" name="items" value="" placeholder="<?php echo get_phrase("insert_an_item_and_press_enter"); ?> ( burger, pizza, cold drinks)">
                                    </div>
                                    <div class="form-group">
