                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    foreach ($foodtruck_ids as $foodtruck_id) :
                                                        ...
                                                        <a href="<?php echo site_url('home/foodtruck/' . rawurlencode(sanitize($foodtruck_detail['slug'])) . '/' . $foodtruck_detail['id']); ?>" class="text-dark" target="_blank"><small class="d-block"> ∙ <?php echo sanitize($foodtruck_detail['name']); ?></small></a>
                                                    <?php endforeach; ?>
                                                </td>
                                                <td>
