        ...
        <div class="col-lg-3">
            ...
            <div class="card min-height-266">
                ...
                <div class="card-body box-profile">
                    ...
                    <p class=" text-center"><small class="text-muted"><?php echo count($this->foodtruck_model->get_foodtrucks_by_cuisine(sanitize($cuisine['id']))) . ' ' . get_phrase('foodtrucks_registered'); ?></small></p>
