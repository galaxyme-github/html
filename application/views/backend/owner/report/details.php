<div class="row justify-content-center">
    <div class="col-md-12">
        <div class="alert alert-info alert-dismissible fade show lighten-info" role="alert">
            ...
            <p>
                <?php echo get_phrase('the_appeared_total_bill_for_each_order_is_the_summation_of_your_specific_foodtruck_delivery_charge'); ?>, <?php echo strtolower(get_phrase('the_items_ordered')); ?> <?php echo strtolower(get_phrase('and')); ?> <?php echo sanitize(get_delivery_settings('vat')); ?>% VAT.
                <strong>
                    <?php echo get_phrase('it_can_be_different_from_the_actual_total_bill_because_customer_can_order_from_another_foodtruck_also'); ?>.
                </strong>
            </p>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <?php echo get_phrase("order_wise_commission_list_for_owner", true); ?> <small>( <?php echo sanitize(get_delivery_settings('foodtruck_revenue')) . '% ' . get_phrase('commission_in_each_order') ?>)</small>
                    </h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
