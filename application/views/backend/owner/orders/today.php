                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <select class="form-control select2 w-100" name="foodtruck_id" id="foodtruck_id">
                                    <option value="" <?php if ($foodtruck_id == "all") echo "selected"; ?>><?php echo get_phrase('all'); ?></option>
                        ...
                        <tbody>
                            ...
                            foreach ($orders as $order) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        $foodtruck_ids = $this->order_model->get_foodtruck_ids(sanitize($order['code']));
                                        foreach ($foodtruck_ids as $foodtruck_id) :
                                            $foodtruck_detail = $this->foodtruck_model->get_by_id(sanitize($foodtruck_id)); ?>
                                            <?php if (isset($foodtruck_detail['id'])) : ?>
                                                <a href="<?php echo site_url('home/foodtruck/' . sanitize(rawurlencode($foodtruck_detail['slug'])) . '/' . sanitize($foodtruck_detail['id'])); ?>" class="text-dark" target="_blank"><small class="d-block"> ∙ <?php echo sanitize($foodtruck_detail['name']); ?></small></a>
                                            <?php else: ?>
