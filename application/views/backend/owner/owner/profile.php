        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <?php $foodtrucks = $this->foodtruck_model->get_foodtrucks_by_condition(['owner_id' => sanitize($owner['id'])]); ?>
                        <?php if (count($foodtrucks) > 0) : ?>
                            <?php foreach ($foodtrucks as $key => $foodtruck) : ?>
                                <strong><i class="fas fa-utensils"></i></strong> <a href="<?php echo site_url('home/foodtruck/' . rawurlencode(sanitize($foodtruck['slug'])) . '/' . sanitize($foodtruck['id'])) ?>"><span class="text-muted"><?php echo sanitize($foodtruck['name']); ?></span></a>
                            ...
                            <?php endforeach; ?>
                        <?php else : ?>
                            <?php if ($owner['number_of_approved_foodtrucks'] == 0 && $owner['number_of_pending_foodtrucks'] == 0) : ?>
                        ...
                        <div class="tab-content">
                            ...
                            <div class=" <?php if ($tab == "activity") echo "active"; ?> tab-pane" id="activity">
                                <div class="alert alert-warning lighten-info alert-dismissible">
                                    <strong><?php echo get_phrase('note'); ?></strong> : <?php echo get_phrase('since_a_foodtruck_owner_can_also_order_from_various_foodtruck'); ?>, <?php echo get_phrase('these_are_the_orders_made_by') . ' ' . $owner['name']; ?>.
                                </div>
                                <!-- The timeline -->
