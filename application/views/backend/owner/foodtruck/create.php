...
<section class="content">
    <div class="container-fluid">
        <form class="" action="<?php echo site_url('foodtruck/store') ?>" method="post">
                    ...
                    <div class="card card-secondary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="foodtruck_name" name="foodtruck_name" placeholder="<?php echo get_phrase("enter_foodtruck_name"); ?>" required>
                            </div>
                            <div class="form-group">
