                    ...
                    <div class="card card-outline card-warning">
                        <div class="card-body">
                            ...
                            <span class="d-block text-xs"><strong><?php echo get_phrase('ordered_from'); ?> : </strong>
                                <?php
                                $foodtruck_ids = $this->order_model->get_foodtruck_ids(sanitize($approved['code']));
                                foreach ($foodtruck_ids as $foodtruck_id) :
                                    ...
                                    <?php if (isset($foodtruck_detail['id'])) : ?>
                                        ∙ <?php echo sanitize($foodtruck_detail['name']); ?>
                                    <?php else: ?>
                ...
                ?>
                    <div class="card card-outline card-info">
                        <div class="card-body">
                            ...
                            <span class="d-block text-xs"><strong><?php echo get_phrase('ordered_from'); ?> : </strong>
                                <?php
                                $foodtruck_ids = $this->order_model->get_foodtruck_ids(sanitize($preparing['code']));
                                foreach ($foodtruck_ids as $foodtruck_id) :
                                    $foodtruck_detail = $this->foodtruck_model->get_by_id(sanitize($foodtruck_id)); ?>
                                    ∙ <?php echo sanitize($foodtruck_detail['name']); ?>
                                <?php endforeach; ?>
                ...
                ?>
                    <div class="card card-outline card-maroon">
                        <div class="card-body">
                            ...
                            <span class="d-block text-xs"><strong><?php echo get_phrase('ordered_from'); ?> : </strong>
                                <?php
                                $foodtruck_ids = $this->order_model->get_foodtruck_ids(sanitize($prepared['code']));
                                foreach ($foodtruck_ids as $foodtruck_id) :
                                    $foodtruck_detail = $this->foodtruck_model->get_by_id(sanitize($foodtruck_id)); ?>
                                    ∙ <?php echo sanitize($foodtruck_detail['name']); ?>
                                <?php endforeach; ?>
                ...
                ?>
                    <div class="card card-outline card-success">
                        <div class="card-body">
                            ...
                            <span class="d-block text-xs"><strong><?php echo get_phrase('ordered_from'); ?> : </strong>
                                <?php
                                $foodtruck_ids = $this->order_model->get_foodtruck_ids(sanitize($delivered['code']));
                                foreach ($foodtruck_ids as $foodtruck_id) :
                                    $foodtruck_detail = $this->foodtruck_model->get_by_id(sanitize($foodtruck_id)); ?>
                                    ∙ <?php echo sanitize($foodtruck_detail['name']); ?>
                                <?php endforeach; ?>
