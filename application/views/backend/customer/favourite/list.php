                        ...
                        <tbody>
                            ...
                            foreach ($favourites as $favourite) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo site_url('home/foodtruck/' . sanitize(rawurlencode($favourite['foodtruck_slug'])) . '/' . sanitize($favourite['foodtruck_id'])); ?>"><?php echo sanitize($favourite['foodtruck_name']); ?></a>
                                    </td>
                                    <td>
