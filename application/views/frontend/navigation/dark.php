		...
		<div class="row">
			<div class="col-md-12">
				<nav id="nav" class="navbar navbar-expand-lg navbar-light">
					<a class="navbar-brand" href="<?=site_url("site");?>"> <img src="<?=base_url('uploads/system/' . get_website_settings('website_logo'));?>" class="system-icon"> <span class="d-none d-sm-inline-block"><?php //echo get_system_settings('system_name');?></span> </a>
					...
					<div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
						<ul class="navbar-nav">
							<li class="nav-item">
								<a class="nav-link" href="<?=site_url('site/become_a_member');?>"><i class="far fa-heart"></i>&nbsp;Become a BFT Member</a>
							</li>
						</ul>
