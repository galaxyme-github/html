...
<script>
  $(".wishlist-heart").on("click", function(e) {
    ...
    $(e.target).siblings(".wishlist-fulfill-heart").removeClass("d-none");
  });
  $(".wishlist-fulfill-heart").on("click", function(e) {
    $(e.target).addClass("d-none");
    $(e.target).siblings(".wishlist-heart").removeClass("d-none");
  });
</script>