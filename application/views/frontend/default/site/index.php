        ...
        <div class="row" style="margin-top: 180px;">
            <div class="col-md-12">
                <div class="slider-content_wrap">
                    <h1 class="home-title beauty-title-black">Catering Food Trucks for every occasion</h1>
                    <h5 class="beauty-title-black">Weddings - anniversaries - corperate events....</h5>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center mb-5">
            <div class="col-md-4">
                <div class="featured-btn-wrap">
                    <a href="<?=site_url('site/become_a_member');?>" class="btn ft-btn"><i class="fa fa-user-plus pr-2"></i>Become a BFT Member</a>
                </div>
            </div>
        </div>
    </div>
