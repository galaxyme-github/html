					...
					<div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
						...
						<div class="float-right">
							<ul class="navbar-nav">
								...
								<!-- <li>
									<a href="<?php echo site_url('cart'); ?>" class="btn btn-outline-dark cart-btn"><span class="cart-items" id="#cart-items"><?php echo sanitize($this->cart_model->total_cart_items()); ?></span><span class="ti-shopping-cart"></span></a>
								</li> -->
								<?php }else { ?>
								<li class="nav-item">
