...
<script src="<?php echo base_url('assets/frontend/default/js/input-spinner-custom-editors.js') ?>"></script>
<script src="<?php echo base_url('assets/frontend/default/js/input-spinner.js') ?>"></script>
<!-- Datepicker JS -->
