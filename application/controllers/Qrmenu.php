...
class Qrmenu extends Base
{
    ...
    */
    ...
    public function generate() {
        $foodtruck_id = sanitize($this->input->post('foodtruck_id'));
        ...
        $config['data'] = site_url('home/foodtruck/' . sanitize(rawurlencode($foodtruck_details['slug'])) . '/' . sanitize($foodtruck_details['id']));
        $config['level'] = 'H';
        $config['size'] = 10;
